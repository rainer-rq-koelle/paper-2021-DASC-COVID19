...
```{r}
#THRESHOLD AT A FIXED QUANTILE PER YEAR
ds1 <- full_dataset %>% group_by(YR = year(DATE), DATE) %>% summarize(N = n()) %>% mutate(THRESHOLD = quantile(N, probs = 0.7))
ds1
