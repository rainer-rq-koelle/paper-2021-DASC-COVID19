...
tmp %>%
  ...
  geom_line(aes(x = DATE, y = MED), color = "green") +
  scale_color_brewer(type = "seq") +
  new_scale_colour() +
  geom_line(aes(x = DATE, y = BAND, group= "1"), colour = if_else(tmp$LOW_CRIT, "red","green"), size = 10) +
  geom_line(aes(x = DATE, y = BAND-500, group= "1"), colour = if_else(tmp$UP_CRIT, "red","green"), size = 4) +
  geom_line(aes(x = DATE, y = BAND-1500, group= "1", colour = STATE), size = 4) +
